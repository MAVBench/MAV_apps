...
#ax3.scatter(octomap_exposed_resolution, point_cloud_estimated_volume, octomap_integeration_response_time)#, zdir='z', c=None, depthshade=True)#(, *args, **kwargs)

# -- for octomap to planner (data_1/stats.json_om_to_pl)
ax3.scatter(resolution_to_explore_knob_modeling, potential_volume_to_explore_knob_modeling, octomap_to_motion_planner_serialization_to_reception_knob_modeling)#, zdir='z', c=None, depthshade=True)#(, *args, **kwargs)
#ax3.scatter(resolution_to_explore_knob_modeling, potential_volume_to_explore_knob_modeling, octomap_to_planner_com_overhead_knob_modeling)#, zdir='z', c=None, depthshade=True)#(, *args, **kwargs)

# -- for piecewise planner (data_1/stats.json_pp_pl)
#ax3.scatter(piecewise_planner_resolution_knob_modeling, piecewise_planner_volume_explored_knob_modeling, piecewise_planner_time_knob_modeling)#, zdir='z', c=None, depthshade=True)#(, *args, **kwargs)
