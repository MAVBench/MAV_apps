...
class DataParser(object):
	...
	def parse_om_pl(self):
		resolution_to_explore_knob_modeling = self.result_dic["om_to_pl_res_knob_modeling"]
		potential_volume_to_explore_knob_modeling= self.result_dic["om_to_pl_vol_actual_knob_modeling"]
	...
	def parse_pp_pl(self):
		piecewise_planner_resolution_knob_modeling = self.result_dic["om_to_pl_res_knob_modeling"]
		piecewise_planner_volume_explored_knob_modeling = self.result_dic["ppl_vol_actual_knob_modeling"]
