        ...
        geometry_msgs::Twist& twist, geometry_msgs::Twist& acceleration)
{
    ...
    multiDOFpoint mdofp = trajectory_at_time(g_next_steps_msg, g_ppl_time_budget);
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher inform_point_cloud_done_pub = nh.advertise<std_msgs::Bool>("inform_pc_done", 1);  // -- for profiling purposes
