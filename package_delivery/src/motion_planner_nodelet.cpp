...
void motion_planning_initialize_params() {
    ...
    ros::param::get("/motion_planner_nodelet/max_roadmap_size", max_roadmap_size__global);
    ros::param::get("/motion_planner_nodelet/sampling_interval", sampling_interval__global);
    ros::param::get("/motion_planner_nodelet/rrt_step_size", rrt_step_size__global);
    ros::param::get("/motion_planner_nodelet/rrt_bias", rrt_bias__global);
    ros::param::get("/motion_planner_nodelet/x_dist_to_sample_from__low_bound", x__low_bound__global);
    ros::param::get("/motion_planner_nodelet/x_dist_to_sample_from__high_bound", x__high_bound__global);

    ros::param::get("/motion_planner_nodelet/y_dist_to_sample_from__low_bound", y__low_bound__global);
    ros::param::get("/motion_planner_nodelet/y_dist_to_sample_from__high_bound", y__high_bound__global);
    ros::param::get("/motion_planner_nodelet/z_dist_to_sample_from__low_bound", z__low_bound__global);
    ros::param::get("/motion_planner_nodelet/z_dist_to_sample_from__high_bound", z__high_bound__global);
    ros::param::get("/motion_planner_nodelet/nodes_to_add_to_roadmap", nodes_to_add_to_roadmap__global);
    ros::param::get("/motion_planner_nodelet/max_dist_to_connect_at", max_dist_to_connect_at__global);
    ...
    ros::param::get("/motion_planner_nodelet/v_max", v_max__global);
    ros::param::get("/motion_planner_nodelet/a_max", a_max__global);
    ros::param::get("ros_DEBUG", DEBUG__global);
    //std::cout<<"max_dist_to_"<<max_dist_to_connect_at__global<<std::endl;
    
    ros::param::get("/motion_planner_nodelet/motion_planning_core", motion_planning_core_str);
...
class MotionPlannerNodelet: public nodelet::Nodelet {
public:
    virtual void onInit() {
        ...
        service = nh.advertiseService("get_trajectory_srv", get_trajectory_fun);
    ...
    ros::Publisher smooth_traj_vis_pub;
    ros::Publisher piecewise_traj_vis_pub;
...
PLUGINLIB_EXPORT_CLASS(mp_pkg::MotionPlannerNodelet, nodelet::Nodelet)
